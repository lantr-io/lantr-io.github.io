---
title: "FROST Explained: Schnorr Threshold Signatures for Bitcoin"
author: "Alexander Nemish"
tags: "bitcoin frost schnorr threshold signatures multisig shamir secret sharing distributed key generation taproot BIP-340"
publishedAt: '2026-02-05'
summary: "A step-by-step guide to FROST (RFC 9591) threshold Schnorr signatures for Bitcoin — from Schnorr basics through Shamir secret sharing to the full protocol, with worked examples."
---

## Contents

- [Introduction](#introduction)
- [Schnorr Signatures](#schnorr-signatures) — elliptic curve setup, signing, verification, and why nonces matter
- [Aggregating Nonce R](#aggregating-nonce-r) — binding factors and why naive aggregation is dangerous
- [Aggregating Partial Signatures](#aggregating-partial-signatures) — share equations, sum correctness, identifiable abort
- [Shamir Secret Sharing](#shamir-secret-sharing) — polynomials, Pedersen DKG, Feldman VSS
- [Lagrange Interpolation](#lagrange-interpolation) — the formula, intuition, and concrete examples
- [FROST Protocol](#frost-protocol) — setup, rounds, aggregation, worked example
...
<ZoomableImage src="/img/frost/elliptic-curve.svg" alt="Elliptic curve point addition: P + Q is found by drawing a line through P and Q, finding the third intersection, and reflecting it" />
...
<ZoomableImage src="/img/frost/shamir-polynomial.svg" alt="Shamir (2,3) secret sharing: the secret s = 16 is the y-intercept, shares are points on the line f(x) = 16 + 6x" />
...
<ZoomableImage src="/img/frost/frost-protocol-flow.svg" alt="FROST protocol flow: two rounds between participants and coordinator, producing a standard Schnorr signature" />
...
The protocol is standardized in [**RFC 9591**](https://www.rfc-editor.org/rfc/rfc9591.html) (June 2024), with ciphersuites for Ed25519, Ed448, P-256, and secp256k1.
...
- **FROST Interactive Explainer:** [romarq.github.io/FROST-Interactive-Explainer](https://romarq.github.io/FROST-Interactive-Explainer/)
