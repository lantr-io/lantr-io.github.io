...
tags: cardano fee-market transaction-fees DDoS mempool congestion prioritization
publishedAt: '2024-11-05'
summary: "Why Cardano needs transaction fee prioritization: Analysis of DDoS vulnerabilities, mempool congestion, and proposed solutions for fair transaction ordering."
---
...
![Cardano DDoS attack cost calculation](/img/cardano-ddos-calculation.png)
...
![Preservation of Value](/img/value-preservation.png)
