...
This is the companion benchmarking article to our [guide on authenticated collections in Scalus](https://scalus.org/docs/advanced-data-structures). If you're unfamiliar with Merkle Patricia Forestry (MPF), Fused MPF, or Incremental Merkle Trees, start there for algorithmic explanations and decision guidance.
...
This article is the benchmarking companion to [Authenticated Collections in Scalus — Merkle Trees, Tries & Accumulators for Cardano](https://scalus.org/docs/advanced-data-structures).
