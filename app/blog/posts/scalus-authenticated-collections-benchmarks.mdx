...
This is the companion benchmarking article to our [guide on authenticated collections in Scalus](/blog/scalus-authenticated-collections-guide/). If you're unfamiliar with Merkle Patricia Forestry (MPF), Fused MPF, or Incremental Merkle Trees, start there for algorithmic explanations and decision guidance.
