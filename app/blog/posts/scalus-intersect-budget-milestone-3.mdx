...
And detailed overview of [Payment Methods](https://scalus.org/docs/transactions/payment-methods), [Spending UTxOs](https://scalus.org/docs/transactions/spending-utxos), [Minting and Burning Native Tokens](https://scalus.org/docs/transactions/minting-burning-assets), [Staking: Delegate to Stake Pool, Withdraw Rewards](https://scalus.org/docs/transactions/staking-rewards) and [Governance: Delegate to DRep, Vote](https://scalus.org/docs/transactions/governance).

<ZoomableImage src="/lantr-scalus-site-transactions.jpg" alt="Scalus documentation - Transactions" />
...
<ZoomableImage src="/lantr-scalus-starter.jpg" alt="Scalus documentation - Starter Kit" />
